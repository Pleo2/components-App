        ...
        <ThemedView className="mb-8">
            <ThemedCard>
                <SectionList
                    ...
                    renderItem={({ item }) => <ThemedText type="h2" className="p-1">{item}</ThemedText>}
                    ListHeaderComponent={() => (
                        <ThemedText type="h1" className="mb-4">Personajes</ThemedText>
                    )}
                    renderSectionHeader={({section}) => (
                        <ThemedText type="h1" className="bg-white dark:bg-black/90 p-4 rounded-lg mb-4">
                            {section.title}
                        </ThemedText>
                    )}
                    ListFooterComponent={(() => (
                        <ThemedCard className="my-6">
                            <ThemedText type="h2" className="text-gray-500 ">
